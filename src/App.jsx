...
function App() {
    ...
    <>
      ...
      <div className="grid grid-cols-[250px_1fr_330px] h-screen">
        ...
        <main className="">
          {/* Navbar */}
          <nav className="bg-gray-800 flex justify-start items-center text-white py-4 mb-6 w-full m-0">
            <ul className="flex items-center justify-around w-full text-xl">
              <li>
            ...
            <div className="flex  flex-row ">
              <div className="pl-8">
                ...
                <h1 className="text-md my-2 font-semibold">
                  <li className="list-disc">Mark Sun</li>
                </h1>
                ...
                <div className="mt-4 flex  w-full font-mono font-light text-md">
                  <div className="mr-2  w-[50%] flex flex-col justify-between items-start">
                    <p className="text-[1.2rem]">
                      Barracuda is a family of air-breathing Autonomous Air
                  ...
                  <div className="flex  mt-10 md:mt-0  w-[50%] overflow-hidden">
                    <img src={plane} className=" w-full h-full" alt="Avatar" />
                  </div>
                </div>
                <div className="flex items-center px-6 justify-between w-full">
                  <div className="flex mb-4 ml-3 justify-end items-center md:justify-start gap-5 pt-4">
        ...
        {/* Right Sidebar */}
        <aside className="bg-gray-100 px-4 py-2 border-l  border-gray-300">
          <ul>
            <li className="mb-4 flex flex-col  gap-1">
              <h3 className="font-bold  text-[1.2rem]">#discuss</h3>
            ...
            <li className="mb-2  flex flex-col  gap-1">
              <h3 className="font-semibold text-[1rem]">
                Why cessena is doubling it’s production?
              </h3>
              <p className="text-[.8rem]">21 comments</p>
            </li>
            <li className="mb-2  flex flex-col  gap-1">
              <h3 className="font-semibold  text-[1rem]">
                Why cessena is doubling it’s production?
